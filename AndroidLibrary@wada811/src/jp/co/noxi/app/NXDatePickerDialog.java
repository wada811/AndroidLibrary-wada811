...
public class NXDatePickerDialog extends NXDialog implements DatePickerDialog.OnDateSetListener {
     ...
     */
    public static <T extends Fragment & OnDateSetListener>NXDatePickerDialog newInstance(T callback, int year, int month, int day){
     ...
     * @param day The initial day of the dialog.
     */
    public static <T extends Activity & OnDateSetListener>NXDatePickerDialog newInstance(T callback, int year, int month, int day){
        return newInstanceInternal(callback, VALUE_NULL, year, month, day);
    }
     ...
     * @param day The initial day of the dialog.
     */
    public static <T extends Fragment & OnDateSetListener>NXDatePickerDialog newInstance(T callback, int theme, int year, int month, int day){
     ...
     * @param day The initial day of the dialog.
     */
    public static <T extends Activity & OnDateSetListener>NXDatePickerDialog newInstance(T callback, int theme, int year, int month, int day){
        return newInstanceInternal(callback, theme, year, month, day);
    }

    static NXDatePickerDialog newInstanceInternal(OnDateSetListener callback, int theme, int year, int month, int day){
    ...
    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth){
        ...
        final OnDateSetListener listener = findListenerByTag(OnDateSetListener.class, getArguments(), ARG_LISTENER);
        if(listener != null){
