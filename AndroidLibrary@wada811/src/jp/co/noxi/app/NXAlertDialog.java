...
public class NXAlertDialog extends NXDialog {
    ...
    public static class Builder {
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public <TAdapter extends Fragment & ListAdapterDelegate, TListener extends Fragment & OnChoiceClickListener>Builder setAdapter(TAdapter adapter, TListener listener){
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public <TAdapter extends Activity & ListAdapterDelegate, TListener extends Activity & OnChoiceClickListener>Builder setAdapter(TAdapter adapter, TListener listener){
            putArgument(ARG_ADAPTER, adapter);
            putArgument(ARG_ADAPTER_LISTENER, listener);
            return this;
        }
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public <TAdapter extends Fragment & ListAdapterDelegate, TListener extends Activity & OnChoiceClickListener>Builder setAdapter(TAdapter adapter, TListener listener){
            putArgument(ARG_ADAPTER, adapter);
            putArgument(ARG_ADAPTER_LISTENER, listener);
            return this;
        }
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public <TAdapter extends Activity & ListAdapterDelegate, TListener extends Fragment & OnChoiceClickListener>Builder setAdapter(TAdapter adapter, TListener listener){
            putArgument(ARG_ADAPTER, adapter);
            putArgument(ARG_ADAPTER_LISTENER, listener);
            return this;
        }
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public <T extends Fragment & OnMultiChoiceClickListener>Builder setMultiChoiceItems(CharSequence[] items, boolean[] checkedItems, T listener){
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public <T extends Fragment & OnMultiChoiceClickListener>Builder setMultiChoiceItems(int itemsId, boolean[] checkedItems, T listener){
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public <T extends Activity & OnMultiChoiceClickListener>Builder setMultiChoiceItems(CharSequence[] items, boolean[] checkedItems, T listener){
            mArguments.putCharSequenceArray(ARG_MULTI_CHOICE_ITEMS, items);
            mArguments.putBooleanArray(ARG_CHECKED_ITEMS, checkedItems);
            putArgument(ARG_MULTI_CHOICE_LISTENER, listener);
            return this;
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public <T extends Activity & OnMultiChoiceClickListener>Builder setMultiChoiceItems(int itemsId, boolean[] checkedItems, T listener){
            return setMultiChoiceItems(mContext.getResources().getTextArray(itemsId), checkedItems, listener);
        }
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public <T extends Fragment & OnChoiceClickListener>Builder setSingleChoiceItems(CharSequence[] items, int checkedItem, T listener){
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public <T extends Fragment & OnChoiceClickListener>Builder setSingleChoiceItems(int itemsId, int checkedItem, T listener){
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public <T extends Activity & OnChoiceClickListener>Builder setSingleChoiceItems(CharSequence[] items, int checkedItem, T listener){
            mArguments.putCharSequenceArray(ARG_SINGLE_CHOICE_ITEMS, items);
            mArguments.putInt(ARG_CHECKED_ITEM, checkedItem);
            putArgument(ARG_SINGLE_CHOICE_LISTENER, listener);
            return this;
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public <T extends Activity & OnChoiceClickListener>Builder setSingleChoiceItems(int itemsId, int checkedItem, T listener){
            return setSingleChoiceItems(mContext.getResources().getTextArray(itemsId), checkedItem, listener);
        }
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public <TAdapter extends Fragment & ListAdapterDelegate, TListener extends Fragment & OnChoiceClickListener>Builder setSingleChoiceItems(TAdapter adapter, int checkedItem, TListener listener){
            mArguments.putInt(ARG_CHECKED_ITEM, checkedItem);
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public <TAdapter extends Activity & ListAdapterDelegate, TListener extends Activity & OnChoiceClickListener>Builder setSingleChoiceItems(TAdapter adapter, int checkedItem, TListener listener){
            mArguments.putInt(ARG_CHECKED_ITEM, checkedItem);
            putArgument(ARG_SINGLE_CHOICE_ADAPTER, adapter);
            putArgument(ARG_SINGLE_CHOICE_LISTENER, listener);
            return this;
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public <TAdapter extends Fragment & ListAdapterDelegate, TListener extends Activity & OnChoiceClickListener>Builder setSingleChoiceItems(TAdapter adapter, int checkedItem, TListener listener){
            mArguments.putInt(ARG_CHECKED_ITEM, checkedItem);
            putArgument(ARG_SINGLE_CHOICE_ADAPTER, adapter);
            putArgument(ARG_SINGLE_CHOICE_LISTENER, listener);
            return this;
         ...
         * @return This Builder object to allow for chaining of calls to set methods
         */
        public <TAdapter extends Activity & ListAdapterDelegate, TListener extends Fragment & OnChoiceClickListener>Builder setSingleChoiceItems(TAdapter adapter, int checkedItem, TListener listener){
            mArguments.putInt(ARG_CHECKED_ITEM, checkedItem);
            putArgument(ARG_SINGLE_CHOICE_ADAPTER, adapter);
            putArgument(ARG_SINGLE_CHOICE_LISTENER, listener);
            return this;
    ...
    private void setAdapter(AlertDialog.Builder builder){
        ...
        builder.setAdapter(delegate.getListAdapter(this), new DialogInterface.OnClickListener(){
            ...
            public void onClick(DialogInterface dialog, int which){
                final OnChoiceClickListener listener = findListenerByTag(OnChoiceClickListener.class, ARG_ADAPTER_LISTENER);
    ...
    private void setSingleChoiceItems(AlertDialog.Builder builder){
        ...
        if(items != null){
            builder.setSingleChoiceItems(items, checkedItem, new DialogInterface.OnClickListener(){
                @Override
                public void onClick(DialogInterface dialog, int which){
                    final OnChoiceClickListener listener = findListenerByTag(OnChoiceClickListener.class, ARG_SINGLE_CHOICE_LISTENER);
                    if(listener != null){
                        listener.onClick(NXAlertDialog.this, which);
                    }
                }
        ...
        final ListAdapterDelegate delegate = findListenerByTag(ListAdapterDelegate.class, ARG_SINGLE_CHOICE_ADAPTER);
        if(delegate == null){
            return;
        }
        builder.setSingleChoiceItems(delegate.getListAdapter(this), checkedItem, new DialogInterface.OnClickListener(){
            @Override
            public void onClick(DialogInterface dialog, int which){
                final OnChoiceClickListener listener = findListenerByTag(OnChoiceClickListener.class, ARG_SINGLE_CHOICE_LISTENER);
                if(listener != null){
    ...
    private void setPositiveButton(AlertDialog.Builder builder){
        ...
        builder.setPositiveButton(positiveButtonText, new DialogInterface.OnClickListener(){
            @Override
            public void onClick(DialogInterface dialog, int which){
                final OnClickListener listener = findListenerByTag(OnClickListener.class, ARG_POSITIVE_BUTTON_LISTENER);
                if(listener != null){
    ...
    private void setNeutralButton(AlertDialog.Builder builder){
        ...
        builder.setNeutralButton(naturalButtonText, new DialogInterface.OnClickListener(){
            @Override
            public void onClick(DialogInterface dialog, int which){
                final OnClickListener listener = findListenerByTag(OnClickListener.class, ARG_NEUTRAL_BUTTON_LISTENER);
                if(listener != null){
    ...
    private void setNegativeButton(AlertDialog.Builder builder){
        ...
        builder.setNegativeButton(negativeButtonText, new DialogInterface.OnClickListener(){
            @Override
            public void onClick(DialogInterface dialog, int which){
                final OnClickListener listener = findListenerByTag(OnClickListener.class, ARG_NEGATIVE_BUTTON_LISTENER);
                if(listener != null){
    ...
    private void setItems(AlertDialog.Builder builder){
        ...
        builder.setItems(items, new DialogInterface.OnClickListener(){
            @Override
            public void onClick(DialogInterface dialog, int which){
                final OnChoiceClickListener listener = findListenerByTag(OnChoiceClickListener.class, ARG_ITEMS_LISTENER);
                if(listener != null){
                    listener.onClick(NXAlertDialog.this, which);
                }
            }
    ...
    private void setMultiChoiceItems(AlertDialog.Builder builder){
        ...
        builder.setMultiChoiceItems(items, checked, new DialogInterface.OnMultiChoiceClickListener(){
            ...
            public void onClick(DialogInterface dialog, int which, boolean isChecked){
                final OnMultiChoiceClickListener listener = findListenerByTag(OnMultiChoiceClickListener.class, ARG_MULTI_CHOICE_LISTENER);
                if(listener != null){
