...
public class NXTimePickerDialog extends NXDialog implements TimePickerDialog.OnTimeSetListener {
     ...
     */
    public static <T extends Fragment & OnTimeSetListener>NXTimePickerDialog newInstance(T callback, int hourOfDay, int minute, boolean is24HourView){
     ...
     * @param is24HourView Whether this is a 24 hour view, or AM/PM.
     */
    public static <T extends Activity & OnTimeSetListener>NXTimePickerDialog newInstance(T callback, int hourOfDay, int minute, boolean is24HourView){
        return newInstanceInternal(VALUE_NULL, callback, hourOfDay, minute, is24HourView);
    }
     ...
     * @param is24HourView Whether this is a 24 hour view, or AM/PM.
     */
    public static <T extends Fragment & OnTimeSetListener>NXTimePickerDialog newInstance(int theme, T callback, int hourOfDay, int minute, boolean is24HourView){
     ...
     * @param is24HourView Whether this is a 24 hour view, or AM/PM.
     */
    public static <T extends Activity & OnTimeSetListener>NXTimePickerDialog newInstance(int theme, T callback, int hourOfDay, int minute, boolean is24HourView){
        return newInstanceInternal(theme, callback, hourOfDay, minute, is24HourView);
    }

    static NXTimePickerDialog newInstanceInternal(int theme, OnTimeSetListener callback, int hourOfDay, int minute, boolean is24HourView){
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute){
        ...
        final OnTimeSetListener listener = findListenerByTag(OnTimeSetListener.class, getArguments(), ARG_LISTENER);
        if(listener != null){
