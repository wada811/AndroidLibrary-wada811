...
public class TabMoreTitleActionBarActivity extends ActionBarActivity implements TabFragmentCallbackProvider {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        addTab("More Title Tab 0");
        addTab("More Title Tab 1");
        addTab("More Title Tab 2");
        addTab("More Title Tab 3");
        addTab("More Title Tab 4");
        addTab("More Title Tab 5");
    }
