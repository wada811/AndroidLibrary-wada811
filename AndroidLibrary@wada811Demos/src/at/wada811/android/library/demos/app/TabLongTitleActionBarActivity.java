...
public class TabLongTitleActionBarActivity extends ActionBarActivity implements TabFragmentCallbackProvider {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        addTab("Long Long Title Tab 0");
        addTab("Long Long Title Tab 1");
        addTab("Long Long Title Tab 2");
    }
